...
class Properties {
    ...
    // BASE_URL
    getBaseUrl() { return this.getProperty('BASE_URL'); }
    setBaseUrl(value) {   this.setProperty('BASE_URL', value); }
    hasBaseUrl() { return this.hasProperty('BASE_URL'); }
  
    // USERNAME
    getUsername() { return this.getProperty('USERNAME'); }
    setUsername(value) {   this.setProperty('USERNAME', value); }
    hasUsername() { return this.hasProperty('USERNAME'); }
  
    // PASSWORD
    getPassword() { return this.getProperty('PASSWORD'); }
    setPassword(value) {   this.setProperty('PASSWORD', value); }
    hasPassword() { return this.hasProperty('PASSWORD'); }
  
    // TOKEN
    getToken() { return this.getProperty('TOKEN'); }
    setToken(value) {   this.setProperty('TOKEN', value); }
    hasToken() { return this.hasProperty('TOKEN'); }
